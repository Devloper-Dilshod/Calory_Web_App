    ...
    if (!result) {
        return (
            <div className="text-center text-gray-500 dark:text-gray-400 py-10">
                ...
                <p className="font-semibold">Kaloriya hisobini boshlash uchun yuqoriga taom nomini kiriting.</p>
            </div>
        );
    }
        ...
        <div className="space-y-4 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-green-100 dark:bg-green-800/30 rounded-lg text-center">
                    ...
                    <p className="text-sm text-green-600 dark:text-green-500 font-semibold">Kaloriyalar (Kkal)</p>
                </div>
                <div className="p-4 bg-blue-100 dark:bg-blue-800/30 rounded-lg text-center">
                    ...
                    <p className="text-sm text-blue-600 dark:text-blue-500">Protein</p>
                </div>
                <div className="p-4 bg-yellow-100 dark:bg-yellow-800/30 rounded-lg text-center">
                    ...
                    <p className="text-sm text-yellow-600 dark:text-yellow-500">Yogʻ</p>
                </div>
                <div className="p-4 bg-purple-100 dark:bg-purple-800/30 rounded-lg text-center">
                    ...
                    <p className="text-sm text-purple-600 dark:text-purple-500">Uglevod</p>
                </div>
            </div>
        </div>
    );
